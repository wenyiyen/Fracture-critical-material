...
# # this function does "in-analysis collapse check" before the GM input ends
# proc max_drift_converge_step {ok max_drift collapse_flag tInconvergeOrCollapse max_drift_converged} {
#     if {$ok == 0} {
#         set max_drift [max_drift_model $ctrl_nodes];
#         if {$max_drift >= $col_drift} {
#             set collapse_flag true;
#             set tInconvergeOrCollapse $tCurrent;
#             set max_drift_converged $max_drift;
#         }
#     }
# }