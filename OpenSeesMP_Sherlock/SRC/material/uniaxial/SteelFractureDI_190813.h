...
public:
	...
	// counting function
	void calcDI(double sigcr, double m, int &isStart, int &isSecond, double sig, double &sigPDI, double &DI_cache, double &DI, double &slopeP, std::vector<double> &rev_cnt, int &rev_cnt_endIdx, int &isReadRev);
