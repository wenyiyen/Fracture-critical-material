...
public:
	...
	// counting function
	void calcDI(double sigcr, double m, int &isStart, int &isSecond, double sig, double &sigPDI, double &DI_cache, double &DI, double &slopeP, std::vector<double> &rev_cnt, int &isReadRev);
	int sgn(double v);
