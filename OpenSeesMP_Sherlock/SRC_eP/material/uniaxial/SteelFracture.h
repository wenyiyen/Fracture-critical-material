...
#ifndef SteelFracture_h
#define SteelFracture_h

#include <UniaxialMaterial.h>

class SteelFracture : public UniaxialMaterial
{
public:
	SteelFracture(int tag,
		double fy, double E0, double b,
		double R0, double cR1, double cR2,
		double a1, double a2, double a3, double a4, double epsPlCr);
	/*SteelFracture(int tag,
		double fy, double E0, double b);*/
