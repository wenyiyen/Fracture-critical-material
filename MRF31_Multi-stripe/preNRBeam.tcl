...
proc fracHingeSection {secTag topFMatTag botFMatTag webMatTag webMatTag1 d bf tf tw tabThickness boltLocation boltDiameter FuBolt FuTab FyTab Lc} {
...
set pi [expr acos(-1)];
set boltStressLimit [expr 0.6*$FuBolt*$pi*$boltDiameter*$boltDiameter/4/$AWebFiber];
